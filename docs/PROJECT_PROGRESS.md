...
| M6 | `agent/release-pipeline` | `65cae71..495749f` (merge `8bcf5d9`) | [#8](https://github.com/Prad1se/ai-material-preprocessor/pull/8) | 200 passed, 1 skipped locally; Ruff, mypy, diff, privacy, native light/dark 100%/150% UI, isolated PyInstaller build, packaged self-test, extracted portable GUI smoke, installer lifecycle and deterministic ZIP passed; ZIP SHA-256 `8D853F87346B67C1988B8CBFAC2599752C0B1F39DF92EFA952CFB696C2E71CBF`; both GitHub Actions runs passed | merged |

## Post-RC maintenance and stable release

Post-RC work is tracked separately from the M0-M6 milestone sequence.

| Change | Branch | Commit | Pull request | Verification | Status |
|---|---|---|---|---|---|
| Consented tool supplementation | `agent/tool-installer` | `f2e413e` | [#9](https://github.com/Prad1se/ai-material-preprocessor/pull/9) | 214 passed, 1 skipped locally; Ruff, mypy, diff, PyInstaller self-test and GUI smoke passed; both GitHub Actions runs passed | merged |
| Stable 2.0.0 release | `release/2.0.0-prep` | `eea41b6..1659919` (merge `dc52309`) | [#10](https://github.com/Prad1se/ai-material-preprocessor/pull/10) | 226 passed, 1 skipped locally; Ruff and mypy passed; GitHub pytest and Windows release build passed; portable ZIP, installer, checksums and corresponding FFmpeg source archive published in [v2.0.0](https://github.com/Prad1se/ai-material-preprocessor/releases/tag/v2.0.0) | released |
