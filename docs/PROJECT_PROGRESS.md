...
| M4 | `agent/video-management` | `9031c27` | [#6](https://github.com/Prad1se/ai-material-preprocessor/pull/6) | 162 passed, 1 skipped locally; Ruff, mypy, diff, privacy, native 100%/150% video metadata UI, PyInstaller build, packaged self-test and packaged GUI smoke passed; EXE SHA-256 `445A51F502E99C2A7FC2ED99F980CB1061CA0F2FEE123B3DF0EAC1A27F073259`; GitHub Actions pending | checking |
