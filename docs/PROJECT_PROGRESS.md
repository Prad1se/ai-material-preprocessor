...
| M6 | `agent/release-pipeline` | `65cae71` | [#8](https://github.com/Prad1se/ai-material-preprocessor/pull/8) | 199 passed, 1 skipped locally; Ruff, mypy, diff, privacy, native light/dark 100%/150% UI, isolated PyInstaller build, packaged self-test, extracted portable GUI smoke, installer lifecycle and deterministic ZIP passed; ZIP SHA-256 `8D853F87346B67C1988B8CBFAC2599752C0B1F39DF92EFA952CFB696C2E71CBF`; GitHub Actions pending | checking |
